  ...
  return (
    <div className="min-h-full bg-[--bg-dark] flex-1">
      ...
      <div className="pt-16 pb-12 px-8 max-w-7xl mx-auto">
        <p className="text-[10px] tracking-[0.35em] uppercase font-[family-name:var(--font-dm-sans)] text-[--gold] mb-4">
          Limited Edition
        </p>
        <h1 className="font-[family-name:var(--font-cormorant)] text-5xl md:text-6xl font-light text-white tracking-wide">
          Exclusive
        </h1>
        <p className="mt-4 text-sm font-[family-name:var(--font-dm-sans)] text-[rgba(255,255,255,0.4)] max-w-md leading-relaxed">
