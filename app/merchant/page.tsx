...
export default function MerchantDashboard() {
  ...
  // Active listing count — read persisted listings through the index accessor.
  useDomainSubscription("marketplace-listings-changed", () => marketplaceVersion());
  const activeListings = getMarketplaceListings().filter((l) => l.status === "active").length;
