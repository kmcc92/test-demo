...
export default function AuctionPreviewCard({ auction }: AuctionPreviewCardProps) {
  return (
    <Link href={`/auctions/${auction.id}`} className="group block">
      <div className="relative aspect-[3/4] bg-[--bg-dark-secondary] overflow-hidden mb-4">
      ...
      <div className="space-y-2">
        <h3 className="font-[family-name:var(--font-cormorant)] text-lg font-light text-[--text-primary] tracking-wide group-hover:text-[--gold] transition-colors">
          {auction.name}
        </h3>

        <div className="flex items-baseline justify-between">
          <div>
            <p className="text-[9px] tracking-widest uppercase font-[family-name:var(--font-dm-sans)] text-[--text-primary] mb-0.5">
              Current Bid
            </p>
