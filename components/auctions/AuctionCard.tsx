...
export default function AuctionCard({ auction }: AuctionCardProps) {
  return (
    <Link href={`/auctions/${auction.id}`} className="group block">
      {/* Image */}
      <div className="relative aspect-[3/4] bg-[--bg-dark-secondary] overflow-hidden mb-5">
      ...
      {/* Name */}
      <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-light text-[--text-primary] tracking-wide mb-4 group-hover:text-[--gold] transition-colors duration-200">
        {auction.name}
      </h3>
      ...
      <div className="grid grid-cols-2 divide-x divide-[--border] border border-[--border]">
        <div className="px-3 py-3 text-center">
          <p className="text-[9px] tracking-widest uppercase font-[family-name:var(--font-dm-sans)] text-[--text-primary] mb-1">
            Current Bid
          </p>
